        ...
        <div className="mb-6">
          <div className="relative max-w-md">
            ...
            <Input
              ...
              className="pl-9 h-9 border-border/50 focus-visible:border-border"
            />
          </div>
        </div>
            ...
            {(column) => (
              <div key={column.id} className="flex flex-col gap-3">
                <div className="flex items-center justify-between px-1">
                  ...
                  >
                    <span className="text-lg">{column.unicode}</span>
                    ...
                    >
                      <div className="space-y-2.5">
                        ...
                        <div className="flex flex-wrap items-center gap-2 pt-1">
                          {item.task.assignee && (
                            <div className="inline-flex items-center gap-1.5 px-2 py-1 rounded-md bg-secondary/50 text-xs font-medium">
                        ...
                        <div className="opacity-0 group-hover:opacity-100 transition-opacity -mx-3 -mb-3 mt-2 pt-2 border-t">
                          <Button
                            variant="ghost"
                            size="sm"
